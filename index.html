        ...
        <div class="nav-container" id="navContainer">
          <nav>
            <ul>
              ...
              <li>
                <a href="profil-guru.html"
                  ><i class="fas fa-user-tie"></i> Profil Guru</a
                >
              </li>
              <li>
              ...
              <li>
                <a href="prestasi.html"
                  ><i class="fas fa-trophy"></i> Prestasi</a
                >
              </li>
              <li>
        ...
        <div class="footer-content">
          ...
          <div class="footer-col">
            ...
            <ul>
              ...
              <li>
                <a href="#"><i class="fas fa-chevron-right"></i> Fasilitas</a>
              </li>
              <li>
                <a href="#"><i class="fas fa-chevron-right"></i> Prestasi</a>
              </li>
              <li>
                <a href="#"><i class="fas fa-chevron-right"></i> Pengumuman</a>
              </li>
              <li>
                <a href="#"><i class="fas fa-chevron-right"></i> Galeri</a>
              </li>
              <li>
          ...
          <div class="footer-col">
            ...
            <div class="contact-info">
              ...
              <div>
                <h4>Alamat</h4>
                <p>
                  Jl. Pendidikan No. 123, Desa Rang Perang Laok, Kecamatan
                  Galis, Kabupaten Bangkalan, Jawa Timur
                </p>
              </div>
            </div>
            <div class="contact-info">
